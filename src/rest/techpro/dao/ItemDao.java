...
public class ItemDao /*extends GlobalDao<Item> */{
	...
	private ItemDao() {
		add(new Item("OptiPlex", Brand.DELL, Category.PC_FIXE, "../assets/img/pcDell.png", "Les ordinateurs de bureau OptiPlex sont d�sormais dot�s d�un format restreint et polyvalent et de processeurs Intel� 11e g�n�ration pour exploiter pleinement votre potentiel.", 2345));
		add(new Item("Zenbook Pro", Brand.ASUS, Category.PC_PORTABLE, "../assets/img/pcAsus.png", "Avec le ZenBook Pro, gardez votre style intact tout en accomplissant vos t�ches quotidiennes avec calme et efficacit� ! ", 1545));
		...
		add(new Item("Magic Mouse 2", Brand.APPLE, Category.ACCESSOIRE_PC, "../assets/img/AppleMouse.png", "la Magic Mouse 2 n�est pas seulement belle, mais �galement enti�rement rechargeable, ce qui vous �vite d�utiliser des piles.", 110));
		add(new Item("SANDISK ULTRA FLAIR 3.0 32GO", Brand.SAN_DISK, Category.CLE_USB, "../assets/img/Usb.png", "Passez moins de temps � attendre le transfert de vos fichiers gr�ce � la cl� USB 3.0 Ultra Flair de San Disk.", 20));
		add(new Item("Disque SSD Externe SanDisk Extreme Portable 1 To", Brand.SAN_DISK, Category.DISQUE_DUR, "../assets/img/Disque.png", "Disque SSD portable SanDisk ExtremeLe disque SSD portable et robuste SanDisk Extreme offre des transferts de vitesse �lev�e allant jusqu'� 550 Mo/s.", 255));
		add(new Item("Iphone 11", Brand.APPLE, Category.TELEPHONE_PORTABLE, "../assets/img/Iphone.png", "Dans le prolongement des efforts entrepris pour atteindre nos objectifs en mati�re de protection de l�environnement, l�iPhone 11 est livr� sans adaptateur secteur.", 1200));
		add(new Item("Air pods", Brand.APPLE, Category.ACCESSOIRE_TELEPHONE, "../assets/img/Ecouteur.png", "Des performances inou�es. Dot�s de la puce d��couteurs H1 con�ue par Apple, les AirPods b�n�ficient d�une connexion sans fil plus rapide et plus stable.", 100));
